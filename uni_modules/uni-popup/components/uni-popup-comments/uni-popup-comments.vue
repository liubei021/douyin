...
<template>
	<view class="uni-popup-share">
		<view class="uni-share-title">
			...
			<text class="uni-share-title-text">{{getGraceNumber(thisVlogTotalComentCounts)}} comments</text>
					...
					<view 
						...
						<view class="comments-wrapper" style="margin-left: 16rpx;margin-top: 16rpx;margin-right: 16rpx;">
									...
									<view style="margin-left: 10px;width: 456rpx;">
										<view style="display: flex;flex-direction: row;">
											...
											<view v-if="commentContent.vlogerId == thisVlogerId" class="tag-writer" style="align-self: center;">
												<text class="writer-words" style="align-self: center;">author</text>
											</view>
										...
										<text style="font-size: 32rpx;color: #FFFFFF;margin-top: 10px;">{{commentContent.content}}</text>
									</view>
								</view>
								<view style="display: flex;flex-direction: column;width: 50px;">
									...
									<text style="font-size: 22rpx;color: #878585;align-self: center;margin-top: 5px;">{{getGraceNumber(commentContent.likeCounts)}}</text>
								</view>
							</view>
							<view class="comments-wrapper-sub-down">
								...
								<text style="font-size: 30rpx;color: #878585;margin-left: 20px;" @click="replyComment(commentContent.commentId, commentContent.commentUserNickname)">Reply</text>
							</view>
						</view>
					</view>
	...
	export default {
		...
		data() {
			return {
				...
				bottomTxt: "In the end~ deep no？",
				placeholder: "People who love comments are angels~",
				commentFocus: false,
		...
		methods: {
				...
				uni.request({
					...
					success(result) {				
						...
						if (me.thisVlogTotalComentCounts == 0) {
							me.bottomTxt = "grab a sofa~";
						} else {
							me.bottomTxt = "In the end~deep no？";
						}
			...
			noTypingComment() {
				...
				this.placeholder = "People who love comments are angels~";
			},
			...
			replyComment(commentId, commentUserNickname) {
				...
				this.placeholder = "Reply @" + commentUserNickname;
				// this.typingComment();
			},
